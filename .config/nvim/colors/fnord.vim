...
call s:hi('User1', '#6acdef', s:blue7, '', '')  " main/master branch
call s:hi('User2', s:yellow0, s:blue7, '', '')  " other branch
call s:hi('User3', s:blue7,   s:blue7, '', '')  " hunkline brackets
call s:hi('User4', s:green,   s:blue7, '', '')  " filename
...
call s:hi('FoldColumn', s:blue6, s:blue2, 'NONE', '')
...
call s:hi('ColorColumn', '', s:blue6, 'NONE', '')

call s:hi('TelescopeBorder', s:blue2, s:blue3, 'NONE', '')
call s:hi('TelescopeNormal', s:gray0, s:blue3, 'NONE', '')
call s:hi('TelescopePreviewNormal', s:gray0, s:blue3, 'NONE', '')
call s:hi('TelescopePromptPrefix', s:orange2, s:blue3, 'NONE', '')
" call s:hi('TelescopeSelection', 'black', s:orange, 'NONE', '')
call s:hi('TelescopeSelection', s:red3, s:blue3, 'NONE', '')
call s:hi('TelescopeSelectionCaret', s:orange2, s:blue3, 'NONE', '')
